 ...
 * @version  1.0
 */
public class HostData extends AbstractData {

    /**
     * The domain parameter.
     */
    public static final Parameter DOMAIN =
        new StringParameter(HostData.class, "DOMAIN", "");

    /**
     * The name parameter.
     */
    public static final Parameter NAME =
        new StringParameter(HostData.class, "NAME", "");

    /**
     * The description parameter.
     */
    public static final Parameter DESCRIPTION =
        new StringParameter(HostData.class, "DESCRIPTION", "");

    /**
     * The options parameter.
     */
    public static final Parameter OPTIONS =
        new StringParameter(HostData.class, "OPTIONS", "");
